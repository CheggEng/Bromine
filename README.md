...
*Bromine was designed to be event based by nature, and relies heavily on [https://github.com/arieh/Event](Events.js), its syntax and its methods for passing event arguments*
##Usage
